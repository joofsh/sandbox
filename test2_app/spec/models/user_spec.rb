...
describe User do
    ...
    describe "email address with mixed characters" do
    ...
    describe "when email is not valid format" do
      it "should be valid" do
        addresses = %w[foo@bar.com foo-ho_ea@BAR.com foak@lasd.com a+b@ly.com]
    ...
    describe "when email is unique and NOT case sensitive" do
      before do
        @user_copy = @user.dup
